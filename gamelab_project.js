...
var apple = createSprite(randomNumber(30,370), randomNumber(30,370));
apple.setAnimation("apple");
apple.scale = 0.1;

function randomizeValue(){ //** esélyek kb. 40% - 0, 40% - 1, 20% - mentorBoost
...
function draw() {
  ...
  if(snake.isTouching(apple)){
    randomizeValue();
    pa = pa + value;
    apple.x = randomNumber(30,370);
    apple.y = randomNumber(30,370);
